    ...
    <section className="relative flex min-h-[100svh] items-center overflow-hidden pb-16 pt-32 md:pt-40">
      <div className="container">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <Reveal delay={0.2}>
            <p className="mt-6 mx-auto max-w-[34ch] font-display text-2xl font-semibold leading-tight tracking-tight text-fg-primary md:mt-10 md:max-w-[52ch] md:text-4xl lg:text-5xl">
