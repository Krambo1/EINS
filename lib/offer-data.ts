...
export const BASISPAKET: BasispaketItem[] = [
  ...
  },
  {
    id: "foto-suite",
    number: "02",
    title: "Premium Foto-Suite",
    value: 3500,
    bullets: [
      "20 hochwertige Fotos für Website, Ads und Social Media.",
      "Praxis, Team, Behandlungsräume, Technologie, alles was Vertrauen schafft.",
      "Professionelle Nachbearbeitung auf Premium-Niveau.",
      "Sofort einsetzbar für alle Marketingkanäle.",
    ],
  },
  {
    id: "motion-archiv",
  ...
  },
  {
    id: "landingpages",
    number: "05",
    title: "High-Conversion Landingpages",
    value: 3000,
    bullets: [
      "Dedizierte Landingpages für hochpreisige Behandlungen, ausschließlich für bezahlten Traffic gebaut.",
      "Voroptimierte Templates für Implantate, All-on-4, Invisalign, Veneers, Zahnersatz.",
      "Keine Navigation, kein Ablenkungsmenü, einziges Ziel: Beratungsanfrage.",
      "Trust-Elemente sichtbar: Bewertungen, Zertifikate, Vorher-Nachher, Zahnarzt-Profil, Implantatsystem (Straumann, Nobel Biocare).",
...
export const RETAINER_ROWS: RetainerRow[] = [
  { label: "Monatliche Investition", standard: "2.600 EUR", premium: "3.900 EUR" },
  { label: "Kampagnensteuerung & Optimierung", standard: true, premium: true },
  { label: "Werbebudget-Kontrolle", standard: true, premium: true },
  { label: "Funnel-Optimierung", standard: true, premium: true },
  { label: "Organische Posts auf Social Media", standard: true, premium: true },
  { label: "KI-Lead-Vorqualifizierung und automatisches Routing", standard: true, premium: true },
  { label: "Monatliches Reporting", standard: true, premium: true },
  { label: "Praxis-Reputationssystem (Google-Bewertungen, Testimonials)", standard: true, premium: true },
  { label: "Sales-Playbook für Ihr Praxisteam", standard: true, premium: true },
  ...
  { label: "Neue Content-Assets", standard: false, premium: "1 / Quartal" },
  { label: "Reporting Dashboard (Benly.ai)", standard: "Standard", premium: "Erweitert" },
