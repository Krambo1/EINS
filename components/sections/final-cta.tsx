...
import { CALENDLY_URL, CONTACT_EMAIL, ACTIVE_CLINICS } from "@/lib/constants";
      ...
      <div className="container relative">
        ...
        <Reveal delay={0.15}>
          <p className="mx-auto mt-10 max-w-xl text-center text-fg-secondary">
            Aktuell {ACTIVE_CLINICS} Kliniken in Betreuung. Maximal 1 neues Onboarding pro Monat.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.25}>
          <div className="mt-12 flex flex-col items-center gap-6">
            ...
            <a
              ...
              className="font-mono text-base text-fg-secondary transition-colors hover:text-fg-primary"
            >
